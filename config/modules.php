...
return [
    ...
    */
    'stubs' => [
        ...
        'files' => [
            ...
            'views/dashboard/index' 	=> 'resources/views/dashboard/index.blade.php',
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'praveen'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Praveen Kalaiarasu'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'praveen.kalaiarasu@gmail.com'),
        ],
