...
<x-core::form put action="{{route('app.profile.update.association', ['profile_id' => $profile['id'], 'profile_type' => $profile_type])}}" :model="$profile">
	...
	<div class="row my-6">
		...
		<div class="col w-full">
			...
			<div class="row ">
				...
				<div class="col w-full">
					<x-core::input name="association_name" :100 />
				</div>
				<div class="col w-full md:w-1/2">
					<x-core::input name="association_place" :100 />
				</div>
				<div class="col w-full md:w-1/2">
					<x-core::select name="association_district" :enum="$districts" :100> </x-core::select>
				</div>
				<div class="col w-full md:w-1/2">
