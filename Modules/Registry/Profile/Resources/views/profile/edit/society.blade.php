...
<x-core::form put action="{{route('app.profile.update.society', ['profile_id' => $profile['id'], 'profile_type' => $profile_type])}}" :model="$profile">
...
<div>
	...
	<div class="space-y-4 mb-4">
		<div class="flex justify-between">
			...
			<div class="self-end"> 
				<x-core::anchor back /> 
				<x-core::button primary submit>Update Society Profile</x-core::button>
			</div>
		</div>		
	...
	<div class="row my-6">
		...
		<div class="col w-full">
			...
			<div class="row ">
				...
				<div class="col w-full">
					<x-core::input name="society_name" :100 />
				</div>
				<div class="col w-full md:w-1/2">
					<x-core::input name="society_place" :100 />
				</div>
				<div class="col w-full md:w-1/2">
					<x-core::select name="society_district" :enum="$districts" :100> </x-core::select>
				</div>
				<div class="col w-full md:w-1/2">
